...
public class BoardController {
  ...
  public BoardController() throws Exception {
    ...
    // 2) JSON 문자열을 가지고 java객체를 생성한다.
    // => 배열 형식의 JSON문자열에서 Board의 배열 객체를 생성한다.
  ...
  public Object save() throws Exception {
    PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("boards.ser2")));
