...
public class BoardController {
  ...
  public BoardController() throws Exception {
    ...
    //    while (true) {
    //      try {
    //        Board board = (Board) in.readObject(); // readObejct에 리턴은 원래 Object 객체 주소여서 Board로 바꿔줘야한다.
    //
    //        boardList.add(board);
    //
    //      } catch (Exception e) {
  ...
  public Object save() throws Exception {
    ...
    // 1) 다음과 같이 목록에 들어있는 객체를 한 개씩 순차적으로 serialize할 수도 있고
    //    Object[] arr = boardList.toArray();
    //    for (Object obj : arr) {
    //      out.writeObject(obj);
    //    }

    // 2) 다음과 같이 목록 자체를 serialize할 수도 잇다.
