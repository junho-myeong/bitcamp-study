...
// # 메서드: 개념 및 기본 문법
// - 특정 기능을 수행하는 명령문을 모아둔 블럭

// ## 메서드 문법
// [리턴값의 타입] 함수명(파라미터선언, ...) {명령문들}
// -리턴 값(return value)의 타입?
//      => 함수 블록에 들어 있는 명령문을 수행 완료후
//         그 결과로 놓이는 값의 타입

// - 파라미터(parameter) 선언?
//      => 함수 블록을 실행할때 외부로 부터 받은 값을 저장할 변수 선언

// 1) 명령문 블록을 실행할때 값을 받지 않고 결과도 리턴하지 않는다.
//    일을 시키는데 내가 뭘 줄 필요도 없고 일이 끝난후에 내가 받는것도 없는것
//      void(리턴하지 않겠단소리) 메서드명() {
//          문장1;
//          문장2;
//          }
//2) 명령문 블록을 실행할때 작업에 필요한 값을 받는다. 그러나 결과는 받지 않는다
//취업 자료 주고 지원해 보라고 말하는것과 같다
//void 메서드명(변수선언1, 변수선언2, ...) {
//  문장1;
//  문장2;
//}
//3) 명령문 블록을 실행할 때 값을 받지 않는다. 그러나 작업 결과는 받는다.
//리턴타입 메서드명() {
//  문장1;
//  문장2;
//}
//4) 명령문 블록을 실행할때 작업에 필요한 값을 받는다. 그리고 작업 결과를 리턴한다.
...
public class Exam0210 {
  ...
  public static void main(String[] args) {
    ...
    //          => void 로 지정된 메서드는 리턴값이 없기 때문에 우리가 변수 선언을 해서 그 값을 받으면 컴파일 오류이다.
