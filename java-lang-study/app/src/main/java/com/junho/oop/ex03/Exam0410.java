...
public class Exam0410 {
  ...
  static class Score {
    ...
    // => 중요 !!보통 인스턴스를 만든 후에 인스턴스 변수를 초기화시키는 용도로 정의한다.
  ...
  public static void main(String[] args) {
    ...
    Score s1 = new Score(); // 드디어 클래스 명 다음에 오는 괄호()의 의미를 알게 되었다. 생성자를 호출하는것이다.
    ...
    //    s3.Score(); // 생성자는 따로 호출할수 없다!!!!!! , 생성자는 일반 메서드 처럼 나중에 따로 호출할 수 없다.
