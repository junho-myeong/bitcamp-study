...
public class Exam0212 {
  public static void main(String[] args) {
    ...
    // 문자열로 꺼내기
    String s1 = obj1.toString(); // Object의 toStirng()이 아니다. Long에서 오버라이딩한 toString()이다.
    String s2 = obj2.toString(); // Object의 toStirng()이 아니다. Double에서 오버라이딩한 toString()이다.
    String s3 = obj3.toString(); // Object의 toStirng()이 아니다. Boolean에서 오버라이딩한 toString()이다.
