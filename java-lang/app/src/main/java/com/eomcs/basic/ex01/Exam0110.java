...
public class Exam0110 /*extends Object*/ {
  ...
  static class My /*extends Object*/ { // 중첩클래스에서도 마찬가지로 SuperClass를 지정하지 않으면 SuperClass는 Object이다
  }
  ...
  public static void main(String[] args) {
    ...
    System.out.println(obj.toString()); //인스턴스에 대한 정보를 준다(obj에 toString메서드는) @ 뒤에는 식별 번호이다즉 hash코드이다
