...
public class Sender {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // new socket(원격 호스트의IP 주소/도메인이름, 원격 호스트 프로그램의 포트번호)
    //  => 원격 호스트의 IP주소/ 도메인이름(로컬일 경우,127.0.0.1 /localhost) : 현재 컴퓨터를 가리킨다.
    // 로컬호스트란? 애플리케이션을 실행하는 현재 컴퓨터
    Socket socket = new Socket("localhost", 8888); // 서버에 대기열에 등록 된다면 리턴한다.
