...
public class Exam0522 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String str = new String(buf, 0, count); // 4번째 파라 미터에 인코딩 방식을 알려주면 된다
    // 바이트 배열에 MS949 문자 집합에 따라 인코딩 된 데이터가 들어 있는데,
    // String  클래스는 UTF-8 문자 집합으로 인코딩 되었다고 가정하기 때문에
    // 제대로 읽어서 UTF-16으로 변환 할수 없는것이다.
