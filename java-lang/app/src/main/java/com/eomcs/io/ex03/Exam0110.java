...
public class Exam0110 {
  public static void main(String[] args) throws Exception {
    ...
    //   UCS2 코드를 JVM 환경변수 file.encoding에 설정된 character set 코드로 변환하여 출력한다.
    //   JVM을 실행할 때 -Dfile.encoding=문자집합 옵션으로 기본 문자 집합을 설정한다.
    //   만약 file.encoding 옵션을 설정하지 않으면 OS의 기본 문자 집합으로 설정 된다.
    //
    ...
    //
    //   만약 이클립스에서 실행할 경우,
    //   이클립스가 file.encoding 옵션의 문자 집합을 UTF-8로 설정한다.
