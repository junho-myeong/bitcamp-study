...
// 제네릭 문법에서는 레퍼런스 선언 부분에 확실히 선언해주는게 중요하다
...
public class Exam0211 {
  public static void main(String[] args) {
    // 레퍼런스를 선언할 때 제네릭을 지정하지 않으면
    // 객체생성시 어떤 제네릭 타입을 지정하더라도 상관 없다.
    ArrayList list1; 
    list1 = new ArrayList(); 
    list1 = new ArrayList<>();
    ...
    //   ArrayList객체를 생성할 때 지정한 제네릭 타입은 무시된다.
    ...
    // 레퍼런스 선언시 제네릭 타입을 <?>로 선언하면
    // 객체 생성시 어떤 제네릭 타입을 지정하더라도 상관 없다.
    // 단, 메서드를 사용할 때 주의 해야한다.
    ArrayList<?> list2; 
    list2 = new ArrayList();
    list2 = new ArrayList<>();
