...
public class Exam0220 {
  public static void main(String[] args) throws Exception {
    ...
    Integer i1 = Integer.valueOf(100); // int 값을 가지고 Integer 객체를 생성할때.
    ...
    int v1 = i2.intValue(); // Integer객체에서 int 값을 뽑아 낼때
    System.out.println(v1);

    // 스태틱 메서드 = 클래스 메서드 사용
    int v2 = Integer.parseInt("1280"); //String ==> int 변환
    String s1 = Integer.toBinaryString(77); // int ==> 2진수의 문자열
    ...
    float f = Float.parseFloat("3.14f"); // String ==> float
    boolean b = Boolean.parseBoolean("true"); // String ==> blooean
    System.out.printf("%f, %b\n", f, b);

    float f2 = Float.valueOf("3.14f"); // 문자열을 float으로 간주한다.
    System.out.printf("%f\n", f2);
  }
}
