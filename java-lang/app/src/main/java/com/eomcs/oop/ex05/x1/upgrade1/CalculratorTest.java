...
//  - 곱하기 계산 기능 추가
//  - 기존의 Calculrator클래스에 multiple() 메서드 추가
//
public class CalculratorTest {
  public static void main(String[] args) {
    com.eomcs.oop.ex05.x1.Calculrator c1 = new com.eomcs.oop.ex05.x1.Calculrator();

    c1.plus(100);
    c1.minus(200);
    c1.multiple(2); // 기존 클래스에 새로 추가한 메서드를 호출한다.
...
// 3) 새로 추가한 기능이나 변경한 기능이 다른프로젝트에서 필요없을 때 기존 코드에서 제거하기 힘들다.
