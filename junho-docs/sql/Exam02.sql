...
/* 유니크 값 추가하기*/
alter table test1
  add constraint test1_unique unique(tel);
...
/*
 ...
 => 그리고 결과의 컬럼 타입을 insert 하려면 컬럼의 타입이 같거나 입력 할수 있는 타입이어야한다.
 */

 insert into test2(fullname,phone) select name,tel from test1 where addr='seoul';
